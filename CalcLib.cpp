...
namespace calculus{
    ...
    template<typename T>
    //this function multiplies two matrices and returns the result to `arr1`
...
//                    printf("M1: %5.5lf M2: %5.5lf\n", arr1[k + i * dim2], arr2[j + k * dim3]);
...
//                printf("(%d, %d)\n", i, j);
    ...
    template<typename T>
    //This function multiplies two matrices and returns the result to the array `arr3`
